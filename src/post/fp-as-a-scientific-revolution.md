...
No wonder the functional model may still illicit disbelief. [This essay](/post/functional-programming-and-identity-state-and-time) can be seen as an uphill climb against the gravity of a dominant paradigm; the functional view is perhaps expressible now, but only because of the arduous work put in above. Our natural language is not so easily distorted, violated and repurposed and our thought patterns are comorbid with our language.
