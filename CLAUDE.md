...
4. **No devices that substitute for argument; voice is the author's channel.** No suspense hooks ("There is a catch…"), reveal lines ("…all along."), lecture-hall imperatives ("Notice that…", "Step back…"), or fragments standing in for an inference — and cold opens argue too; narrative gets no exemption. Quips and wry asides ("if I may say so myself") are welcome but reserved for the human author: agent-drafted prose carries no flourish at all, and an agent editing never removes a quip the author added.
