...
4. **No rhetorical devices.** No suspense hooks ("There is a catch…"), reveal lines ("…all along."), lecture-hall imperatives ("Notice that…", "Step back…"), quips, or decorative fragments. Cold opens argue too — narrative gets no exemption.
5. **Don't par upfield.** A theme that deserves development later in the essay must not appear earlier as a passing flourish; the flourish detracts from the point currently being made and cheapens the later treatment. Every sentence serves the paragraph's current point.
